                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function ($dataProvider) {
                            return Html::a('<i class="bi bi-pencil"></i> Editar',  Url::to("/tb-cliente/update?cpf_cnpj=".$dataProvider['cpf_cnpj'], true), ['class' => 'btn btn-danger btn-sm', 'role' => 'modal-remote','target'=>'_blank']);
                        }
                    ],
                ],
            ]); ?>
